...
- **GitHub owner:** `keleustes` (where `gh` pushes; where the repo lives)
...
- **Stack:** go
- **Owner:** `keleustes` (GitHub)
- **Bootstrapped from:** [`claude-meta@dcc0a65ba1e2635dd43c8223a45bc3fdb41338d9`](https://github.com/alemaxdesign/claude-meta) on 2026-08-20T19:47:26Z
...
`<claude-meta>/meta/bin/sync-secrets-to-gh.sh --project armada-crd --ghhandle keleustes`.
