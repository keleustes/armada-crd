...
func (in *AVConf) DeepCopyInto(out *AVConf) {
	*out = *in
	if in.Acconfig != nil {
		in, out := &in.Acconfig, &out.Acconfig
	...
	if in.AutoBridgeAdd != nil {
		in, out := &in.AutoBridgeAdd, &out.AutoBridgeAdd
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.CniNetworkConfig != nil {
		in, out := &in.CniNetworkConfig, &out.CniNetworkConfig
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.Consoleauth != nil {
		in, out := &in.Consoleauth, &out.Consoleauth
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.MetadataAgent != nil {
		in, out := &in.MetadataAgent, &out.MetadataAgent
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.Novncproxy != nil {
		in, out := &in.Novncproxy, &out.Novncproxy
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.OpenstackVersion != nil {
		in, out := &in.OpenstackVersion, &out.OpenstackVersion
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.Spiceproxy != nil {
		in, out := &in.Spiceproxy, &out.Spiceproxy
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
...
func (in *AVNetwork) DeepCopyInto(out *AVNetwork) {
	*out = *in
	...
	if in.HostNamespace != nil {
		in, out := &in.HostNamespace, &out.HostNamespace
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.KubernetesNetloc != nil {
		in, out := &in.KubernetesNetloc, &out.KubernetesNetloc
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.KubernetesServiceIp != nil {
		in, out := &in.KubernetesServiceIp, &out.KubernetesServiceIp
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.RegionProxy != nil {
		in, out := &in.RegionProxy, &out.RegionProxy
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.ServiceCidionApi != nil {
		in, out := &in.ServiceCidionApi, &out.ServiceCidionApi
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
	...
	if in.ServicePeer != nil {
		in, out := &in.ServicePeer, &out.ServicePeer
		*out = new(map[string]ArmadaMapString)
		if **in != nil {
			in, out := *in, *out
			*out = make(map[string]ArmadaMapString, len(*in))
